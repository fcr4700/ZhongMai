 ...
 */
public class FiveHBActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            adapter = new FcrFiveActivityAdapter(FiveHBActivity.this, datas);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String url = getIntent().getStringExtra("fiveHBUrl");
        initView();
        initData(url);
    }
